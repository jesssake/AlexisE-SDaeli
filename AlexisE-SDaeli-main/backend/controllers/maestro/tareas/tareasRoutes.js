...
// =====================================================
// 👨‍🎓 VISTA POR ESTUDIANTE (DIAPOSITIVA) - NUEVAS RUTAS
// =====================================================

// Obtener estudiantes con entregas (para vista por estudiante)
router.get('/estudiantes-con-entregas', (req, res) => {
    console.log('👨‍🎓 GET /estudiantes-con-entregas - Estudiantes con entregas');
    TareasController.obtenerEstudiantesConEntregas(req, res);
});

// Obtener entregas por estudiante
router.get('/entregas-estudiante/:id', (req, res) => {
    console.log(`👨‍🎓 GET /entregas-estudiante/${req.params.id} - Entregas del estudiante`);
    TareasController.obtenerEntregasPorEstudiante(req, res);
});

// =====================================================
// 🔍 DIAGNÓSTICO - ENDPOINT PARA VERIFICAR DATOS
// =====================================================

// Endpoint de diagnóstico para verificar datos de estudiantes y entregas
router.get('/diagnostico', (req, res) => {
    console.log('🔍 GET /diagnostico - Ejecutando diagnóstico');
    TareasController.diagnosticarDatos(req, res);
});
...
router.get('/health', (req, res) => {
    ...
    res.json({
        ...
        endpoints: {
            ...
            estudiantesConEntregas: 'GET /api/maestro/tareas/estudiantes-con-entregas',
            entregasEstudiante: 'GET /api/maestro/tareas/entregas-estudiante/:id',
            diagnostico: 'GET /api/maestro/tareas/diagnostico',
